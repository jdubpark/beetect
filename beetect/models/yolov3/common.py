...
def Conv(input_layer, filters_shape, downsample=False, activate=True, bn=True):
    if downsample:
...
def ResBlock(input_layer, input_channel, filter_num1, filter_num2):
    short_cut = input_layer
    conv = Conv(input_layer, filters_shape=(1, 1, input_channel, filter_num1))
    conv = Conv(conv, filters_shape=(3, 3, filter_num1, filter_num2))
